...
<p>Contactanos &nbsp; <a href="https://api.whatsapp.com/send?phone=524121185143&text=Hola,%20quisiera%20conocer%20m%C3%A1s%20sobre%20tus%20productos"> <i class="fab fa-whatsapp"></i> 412 118 5143 </a></p>
                    ...
                    <div class="our-link">
                        <ul>
                            ...
                            <li><a href="catalogo_productos.php"><i class="fas fa-leaf"></i> Catálogo de Productos</a></li>
                            <li><a href="contacto.php"><i class="fas fa-headset"></i> Contactanos</a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light navbar-default bootsnav">
            <div class="container">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="/"><img src="images/logo1.png" class="logo" alt="Xochicalli" width="220" height="130"></a>
                </div>
                ...
                <div class="collapse navbar-collapse" id="navbar-menu">
                    <ul class="nav navbar-nav ml-auto" data-in="fadeInDown" data-out="fadeOutUp">
                        ...
                        <li class="nav-item"><a class="nav-link" href="catalogo_productos.php">Catálogo de Productos</a></li>
